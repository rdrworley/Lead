...
Status="load inputs"
AALM_OF_IN_v4_091514

TSTOP=50; %10950.; %22000; %10950.;
CINT=1.;

%RBCNL=20.	   %Non-linear threshold concentration (ug/dL RBC)
%SATRAT=350.	 %Saturating (maximum) RBC concentration (ug/dL RBC)
%POWER=1.5	   %Exponent of the algorithm for the deposition fraction (D)
%TORBC=0.24
!!START /NC
...
%	!!START /NC
%	INOTHERPULSE
%	DROUTC=[T INTAKE CBLOOD CPLAS CBONE ABLOOD ABONE];
%	DROUTCC=[DROUTCC DROUTC];
%	INOTHERPULSE=INOTHERPULSE+INCR;
%end
